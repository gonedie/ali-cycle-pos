...
class ManageProductsUnitTest extends BrowserKitTestCase
{
    ...
    public function user_can_create_a_product()
    {
        ...
        $this->type('1000', 'harga_jual');
        $this->type('Baru', 'kondisi');
        $this->type($type->id, 'type_merk_id');
    ...
    public function user_can_edit_a_product_within_search_query()
    {
        ...
        $this->type('1000', 'harga_jual');
        $this->type('Baru', 'kondisi');
        $this->type($unit->id, 'type_merk_id');
        $this->press(trans('product.update'));
